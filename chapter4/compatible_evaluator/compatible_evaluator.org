#+TITLE: Compatible Evaluator
#+PROPERTY: header-args :tangle compatible_evaluator.rkt
#+begin_src scheme
  #lang sicp
#+end_src
...
#+begin_src scheme
  ...
  (define (params procedure)
    (map (lambda (param) (if (pair? param) (car param) param)) (procedure-parameters procedure)))
  (define (args procedure arguments env)
    (map (lambda (param arg) (if (pair? param) (cond ((lazy-param? param) (delay-it arg env))
